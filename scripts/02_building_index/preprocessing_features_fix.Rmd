...
features$HGc<- ifelse(is.na(features$HGNC),features$Ensembl_ID, features$HGNC)
...
test <- read.c=tsv(features_gene_names.tsv)
# see that this only contain known HCGN gene names 
