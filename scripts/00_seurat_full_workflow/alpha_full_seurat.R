...
alpha_positive_genes_PC1 <- c(
  "RPL23A", "RPL3", "RPL13A", "RPL26", "RPS3A", 
  "RPL18A", "RPS23", "RPL7A", "RPS18", "RPL35",
  "ENSG00000237550", "RPSA", "RPL10A", "RPL5", "RPL10", 
  "RPS4X", "EEF1B2", "RPL6", "RPS7", "RPS8",
  "RPS5", "RPL18", "RPS20", "RPL37A", "RPS15A", 
  "RPL12", "RPL24", "RPL35A", "RPS6", "RPS3"
)

alpha_negative_genes_PC1 <- c(
  "IL1RN", "S100A8", "FTH1", "FFAR2", "MNDA", 
  "ACSL1", "APOBEC3A", "TYROBP", "NCF1C", "NINJ1",
  "GLUL", "SNX10", "IFITM3", "FCER1G", "SPI1", 
  "NCF1", "TYMP", "C15orf48", "IER3", "TLR2",
  "CCL4", "CLEC7A", "CCL4L2", "LST1", "S100A11", 
  "NCF2", "VNN2", "SAMSN1", "ISG15", "BASP1"
)
